...
public class FileHandelTXTToCSV {
    ...
    public static File fPath = new File("src/main/FileUsed/StudentData.txt");

    {
        try {
            ...
            while (scanner.hasNext()) {
                ...
                PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("FileOut/StudentData.csv")));

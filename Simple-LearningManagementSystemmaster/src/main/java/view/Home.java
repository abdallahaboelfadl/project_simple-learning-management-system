...
import FileConverted.FileHandelTXTToCSV;
import FileConverted.FileHandelXMLToCSV;
import FileConverted.Data;
import model.Course;
...
public class Home {
    public static void main(String[] args) throws Exception {
        String studentCSVFile = "FileOut/StudentData.csv";
        FileHandelTXTToCSV.csvConvertor(new File("src/main/FileUsed/StudentData.txt"));
        ArrayList<Student> students = Student.getStudent(studentCSVFile);

        String courseCSVFile = "FileOut/CourseData.csv";
        FileHandelXMLToCSV.csvConvertor("src/main/FileUsed/CourseData.xml","FileOut/CourseData.csv");
        ...
        JsonHandel JsonFile = new JsonHandel();
        JSONObject jsonObject = JsonFile.jsonFile(students);

        // Application GUI
        System.out.println("Welcome to LMS");
        System.out.println("created by: (Abdallah Aboelfadel) - feb 09 , 2023 ");
        System.out.println("====================================================================================================");
        System.out.println("Home page");
        System.out.println("====================================================================================================");
        System.out.println("Student List:");

        Data.showStudentCSV("FileOut/StudentData.csv");
        System.out.println("----------------------------------------------------------------------------------------------------");
        ...
        while (true) {
            ...
            System.out.println();
            JsonHandel.SearchByJson(studentId, students, courses);
            ...
            switch (Action) {
                case "a": {
                    ...
                    while (condition) {
                        ...
                        if (courseId.equals("b")) {
                            ...
                            JsonHandel.enrollCourse(studentId, courseId, students, courses, jsonObject);
                        }
                    }
                    break;
                }
                case "d": {
                    ...
                    while (condition) {
                        ...
                        if (CourseId.equals("b")) {
                            ...
                            JsonHandel.unEnrollCourse(studentId, CourseId, students, jsonObject);
                        }
                    }
                    break;
                }
                case "r": {
                    ...
                    while (true) {
                        ...
                        JsonHandel.replaceCourse(studentId, courseId1, courseId2, students, jsonObject);
                        break;
                    }
                }
            }
